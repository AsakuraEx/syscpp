...
@section('contenido')
    ...
    <form action="{{ route('proveedores.update', $proveedor->id) }}" method="POST">
        ...
        <div class="campo">
            ...
            <input 
                type="text" placeholder="Ingresa el nombre del proveedor..." 
                name="nombreProveedor" id="nombreProveedor" value="{{$proveedor->nombreProveedor}}"
            >
        </div>
        <br>
        <div class="campo">
        ...
        <div class="campo">
            ...
            <input 
                type="email" placeholder="Ingresa el correo del proveedor..." 
                name="correoProveedor" id="correoProveedor" value="{{$proveedor->correoProveedor}}"
            >
        </div>
        <br>
